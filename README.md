...
## Getting Started
NearBy is a Facebook Bot Chat helpe., if you Are looking around for the closest places to your location, and without leaving 
...
and facilitating the user Experience, where we include Menus and Buttons ....
